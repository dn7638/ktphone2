        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                <v-dialog v-model="openDialog" width="500">
                    <MqDelivery :offline="offline"  :isNew="true" :editMode="true" v-model="newValue" 
...
<script>
    ...
    import MqDelivery from './../MqDelivery.vue';

    export default {
        name: 'MqDeliveryManager',
        components: {
            MqDelivery,
        },
        props: {
